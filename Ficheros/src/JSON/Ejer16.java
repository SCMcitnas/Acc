...
public class Ejer16{
	...
	public void mostrarJSON(JsonValue json) {
		...
		for(JsonValue apodo : apodos.getValuesAs(JsonValue.class)) {
			System.out.println("Apodos: "+apodo.toString());
		}
		System.out.println("\n");
	}
	
	public static void main(String[] args)  {
		Ejer16 ejer16= new Ejer16();
		ejer16.mostrarJSON(ejer16.leeJSON("https://anapioficeandfire.com/api/characters/583"));
		ejer16.mostrarJSON(ejer16.leeJSON("https://anapioficeandfire.com/api/characters/271"));
